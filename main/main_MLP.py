...
model_filename = f"mlp_model_{timestamp}.pkl"
...
if use_hyperparameter_tuning:
    ...
    best_params = {'hidden_layer_sizes':  (50, 50), 'activation': 'tanh', 'solver': 'adam', 'learning_rate_init': 0.01}
...
# 日志记录
log_experiment(log_path, "mlp", best_params, metrics, save_path)